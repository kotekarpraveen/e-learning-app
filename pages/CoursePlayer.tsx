                        ...
                        <div className="flex overflow-x-auto gap-2 justify-start md:justify-center flex-1 px-2 scrollbar-hide mask-linear-fade">
                            {questions.map((_: any, idx: number) => (
                                <button
                                    ...
                                    className={`w-10 h-10 flex-shrink-0 rounded-lg text-sm font-bold transition-all shadow-sm ${currentQuestionIndex === idx
                                        ...
                                        <div className="p-2 space-y-1">
                                            {module.lessons.map((lesson) => (
                                                <button
                                                    ...
                                                    className={`w-full text-left p-3 rounded-xl flex items-center gap-3 transition-all ${currentLesson?.id === lesson.id ? 'bg-primary-50 text-primary-700 ring-1 ring-primary-100 shadow-sm' : 'hover:bg-gray-50 text-gray-600'
                                                        }`}
                                                >
                                                    <div className={`flex-shrink-0 w-8 h-8 rounded-lg border flex items-center justify-center ${completedLessonIds.has(lesson.id) ? 'bg-green-100 border-green-200 text-green-600' : 'bg-white border-gray-200'
                                                        }`}>
